...
def load_variables(config_file="config.yaml"):
    ...
    prompt_start = """Your decisions must always be made independently without seeking user assistance. Play to your strengths as a large language model and pursue simple strategies with no legal complications."""
